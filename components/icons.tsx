...
export const LogoFull: React.FC<{ className?: string }> = ({ className }) => (
  <div className={`font-bold text-2xl tracking-tight text-brand-text ${className}`}>
    PrepX
  </div>
);

export const LogoIcon: React.FC<{ className?: string }> = ({ className }) => (
  <div className={`font-bold text-xl tracking-tight bg-brand-text text-brand-primary w-8 h-8 flex items-center justify-center rounded-md ${className}`}>
    P
  </div>
);
