...
import { StarIcon, EditIcon, BookIcon, ResizeGripIcon, ChevronDownIcon, ArrowLeftIcon, ChevronRightIcon, PlayCircleIcon } from './icons';
...
const MajorPathView: React.FC<MajorPathViewProps> = ({ onEdit, onChangeMajor, isMobile }) => {
  ...
  return <PathViewer path={majorPath} onEdit={onEdit} onChangeMajor={onChangeMajor} isMobile={isMobile} />;
};
...
const PathViewer: React.FC<{ path: LearningPath; onEdit: (pathId: string) => void; onChangeMajor: () => void; isMobile: boolean }> = ({ path, onEdit, onChangeMajor, isMobile }) => {
